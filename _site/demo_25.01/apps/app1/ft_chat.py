            ...
            ft.Container(
                content=ft.Column(
                    [
                        ...
                        # ft.Text(width=width * 3 / 5, size=16, color=ft.Colors.BLACK),
...
class FtChat(ft.Column):
    ...
    def __init__(self, my_key, on_change_event_async, on_button_event_async, width, height):
        ...
        self.start_message = ft.Container(
            content=ft.Column(
                controls = [
                    # ft.Text('BlindX Realtime Chat', size=32, color=ft.Colors.BLACK),
        ...
        with self.lock:
            ...
            for line in lines:
                ...
                if user_name not in user_names:
                    new_login_text = f'{user_name} さんが会議に参加しました'
                ...
                if line.output_text and line.long_output_text == line.output_text:
                    ...
                    spans = FtColorSpans(output_text, prev_output_text, line.postfix(), self.is_color_span)
